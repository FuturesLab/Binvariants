...
<table>
  <tr>
    ...
    <td>
      <code class="rich-diff-level-one">@inproceedings{yang:binvariants, title = {Binvariants: Enhancing Fuzzing of Closed-source Binary Executables via Register-level Likely Invariants}, author = {Zao Yang and Stefan Nagy}, booktitle = {ACM International Conference on the Foundations of Software Engineering (FSE)}, year = {2026},}</code>
    </td>
  </tr>
  <tr>
